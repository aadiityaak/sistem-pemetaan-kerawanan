...
class KecamatanController extends Controller
{
    ...
    {
        $query = Kecamatan::with(['kabupatenKota.provinsi', 'monitoringData']);
        ...
        $totalCrimes = \App\Models\MonitoringData::count();
        $affectedKecamatan = Kecamatan::has('monitoringData')->count();
