...
const getUnjukRasaForRegion = (kabupatenKotaId: number | null) => {
    ...
    return props.unjukRasaStats.recent_incidents.filter((incident) => incident.location.includes(regionName));
};
    ...
    <AppLayout title="INDAS - Intelligence Data Analysis System">
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="mt-4 flex space-x-3 sm:mt-0 sm:ml-4">
                            <select
                                ...
                                @change="updatePeriod"
                                class="rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                            >
                        ...
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Wilayah</dt>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Ekonomi</dt>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Pariwisata</dt>
                                        <dd class="text-lg font-medium text-gray-900 dark:text-white">
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Sosial</dt>
                                        <dd class="text-lg font-medium text-gray-900 dark:text-white">
                ...
                <div class="mb-8">
                    <div
                        class="cursor-pointer overflow-hidden rounded-lg border border-red-100 bg-gradient-to-r from-red-50 to-orange-50 shadow-lg transition-all duration-300 hover:from-red-100 hover:to-orange-100 hover:shadow-xl dark:border-red-800/30 dark:from-red-900/10 dark:to-orange-900/10 dark:hover:from-red-900/20 dark:hover:to-orange-900/20"
                        @click="openUnjukRasaModal"
                    >
                        <div class="p-6">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 rounded-full bg-white p-3 shadow-md dark:bg-gray-800">
                                        <div v-if="props.unjukRasaStats.subcategory_info?.image_url" class="h-8 w-8 rounded">
                                            <img
                                                :src="props.unjukRasaStats.subcategory_info.image_url"
                                                :alt="props.unjukRasaStats.subcategory_info.name"
                                                class="h-8 w-8 rounded object-contain"
                                            />
                                        </div>
                                        <div v-else class="flex h-8 w-8 items-center justify-center text-2xl">
                                    ...
                                    <div class="ml-6">
                                        ...
                                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Data kejadian demonstrasi dan unjuk rasa terkini</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Total Kejadian</div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Masih Aktif</div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Bulan Ini</div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Tingkat Tinggi</div>
                                    </div>

                                    <!-- Action Button -->
                                    <div class="flex items-center">
                                        <div class="rounded-full bg-white p-2 shadow-md transition-shadow hover:shadow-lg dark:bg-gray-800">
                            ...
                            <!-- Quick Summary -->
                            <div class="mt-4 border-t border-red-200 pt-4 dark:border-red-800/30">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                                <tr v-if="analysisResults.length === 0">
                                    <td colspan="7" class="px-6 py-4 text-center text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                ...
                                <tr v-for="result in analysisResults" :key="result.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <TrendIcon :trend="result.economic_trend" class="ml-2" />
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <TrendIcon :trend="result.tourism_trend" class="ml-2" />
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <TrendIcon :trend="result.social_trend" class="ml-2" />
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <ScoreBadge :score="result.total_score" />
                                            <TrendIcon :trend="result.total_trend" class="ml-2" />
                                        </div>
                                    </td>
                ...
                <div v-if="selectedRegion && regionalInfo[selectedRegion]" class="fixed inset-0 z-50">
                    ...
                    <div class="fixed inset-0 overflow-y-auto">
                        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                            <!-- Modal panel -->
                            <div
                                class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-7xl dark:bg-gray-800"
                            >
                                <div class="p-6">
                                    <!-- Modal Header -->
                                    <div class="flex items-center justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <button
                                                @click="goToDataEntry"
                                                class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                            >
                                    ...
                                    <div class="mt-6 max-h-[70vh] overflow-y-auto">
                                        ...
                                        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                            ...
                                            <div
                                                class="rounded-lg bg-gradient-to-r from-purple-50 to-purple-100 p-4 dark:from-purple-900/20 dark:to-purple-800/20"
                                            >
                                                ...
                                                <div class="space-y-2">
                                                    <div
                                                        v-for="indicator in regionalInfo[selectedRegion].karakter_masyarakat.social_indicators"
                                                        :key="indicator.name"
                                                    >
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <div
                                                class="rounded-lg bg-gradient-to-r from-green-50 to-green-100 p-4 dark:from-green-900/20 dark:to-green-800/20"
                                            >
                                                <div class="mb-3 flex items-center">
                                            ...
                                            <!-- Tourism -->
                                            <div
                                                class="rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 p-4 dark:from-blue-900/20 dark:to-blue-800/20"
                                            >
                                                <div class="mb-3 flex items-center">
                                                ...
                                                <div class="space-y-2">
                                                    <div
                                                        v-for="indicator in regionalInfo[selectedRegion].pariwisata.tourism_indicators"
                                                        :key="indicator.name"
                                                    >
                                                        <div class="flex items-center justify-between">
                                                            <span class="text-sm text-gray-700 dark:text-gray-300">{{ indicator.name }}</span>
                                            ...
                                            <div
                                                class="rounded-lg bg-gradient-to-r from-orange-50 to-orange-100 p-4 dark:from-orange-900/20 dark:to-orange-800/20"
                                            >
                                                <div class="mb-3 flex items-center">
                                                ...
                                                <div class="space-y-2">
                                                    <div class="flex items-center justify-between">
                                                        <span class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                                                            <AcademicCapIcon class="mr-1 h-4 w-4" /> Sekolah
                                                        </span>
                                                        <span class="text-sm font-semibold text-gray-900 dark:text-white">
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <span class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                                                            <HeartIcon class="mr-1 h-4 w-4" /> Rumah Sakit
                                                        </span>
                                                        <span class="text-sm font-semibold text-gray-900 dark:text-white">
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <span class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                                                            <TruckIcon class="mr-1 h-4 w-4" /> Fasilitas Transportasi
                                                        </span>
                                                        <span class="text-sm font-semibold text-gray-900 dark:text-white">
                                                            ~{{
                                                    ...
                                                    <div class="mt-2">
                                                        <p class="text-xs text-gray-500 dark:text-gray-400">
                                                            <InformationCircleIcon class="mr-1 inline h-3 w-3" />
                                        ...
                                        <div v-if="regionalInfo[selectedRegion].titik_demo.length > 0" class="mt-6">
                                            <div class="mb-3 flex items-center">
                                                ...
                                                <h4 class="ml-2 text-base font-medium text-gray-900 dark:text-white">
                                                    Titik-titik Demo (Kategori Keamanan)
                                                </h4>
                                            </div>
                                            <div class="rounded-lg bg-red-50 p-4 dark:bg-red-900/10">
                                                <div class="space-y-3">
                                                    <div
                                                        v-for="demoPoint in regionalInfo[selectedRegion].titik_demo.slice(0, 5)"
                                                        :key="demoPoint.title"
                                                        class="rounded-r-lg border-l-4 border-red-400 bg-white py-2 pl-3 dark:bg-gray-800"
                                                    >
                                                        <div class="flex items-start justify-between">
                                                            <div class="flex-1">
                                                                ...
                                                                <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
                                                                    {{ demoPoint.description }}
                                                                </p>
                                                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">
                                                                    {{ formatDate(demoPoint.incident_date) }}
                                                                </p>
                                                            </div>
                                                            <span
                                                                :class="[
                                                                    'rounded-full px-2 py-1 text-xs font-medium',
                                                                    getSeverityClass(demoPoint.severity_level),
                                                                ]"
                                                            >
                                        ...
                                        <div v-else class="mt-6">
                                            ...
                                            <div
                                                v-if="getUnjukRasaForRegion(selectedRegion).length > 0"
                                                class="rounded-lg bg-orange-50 p-4 dark:bg-orange-900/10"
                                            >
                                                <div class="mb-3 flex items-center">
                                                    <div class="flex items-center">
                                                        <div v-if="props.unjukRasaStats.subcategory_info?.image_url" class="mr-2 h-5 w-5 rounded">
                                                            <img
                                                                :src="props.unjukRasaStats.subcategory_info.image_url"
                                                                :alt="props.unjukRasaStats.subcategory_info.name"
                                                        ...
                                                        <div v-else class="mr-2 flex h-5 w-5 items-center justify-center text-sm">
                                                            {{ props.unjukRasaStats.subcategory_info?.icon || '📢' }}
                                                        </div>
                                                ...
                                                <div class="space-y-2">
                                                    <div
                                                        ...
                                                        :key="index"
                                                        class="group relative rounded-r-lg border-l-3 border-orange-400 bg-white py-2 pl-3 text-xs dark:bg-gray-800"
                                                    >
                                                        <div class="flex items-start justify-between">
                                                            <div class="flex-1">
                                                                ...
                                                                <div class="mt-1 flex items-center space-x-2 text-gray-500 dark:text-gray-400">
                                                            ...
                                                            <Link
                                                                ...
                                                                class="ml-2 p-1 text-gray-400 opacity-0 transition-colors group-hover:opacity-100 hover:text-blue-600 dark:hover:text-blue-400"
                                                    ...
                                                    <div v-if="getUnjukRasaForRegion(selectedRegion).length > 3" class="pt-2 text-center">
                                                        <button
                                                            @click="openUnjukRasaModal"
                                                            class="text-xs text-orange-600 underline hover:text-orange-800 dark:text-orange-400 dark:hover:text-orange-300"
                                                        >
                                            ...
                                            <div v-else class="rounded-lg bg-green-50 p-4 text-center dark:bg-green-900/10">
                                                <p class="text-sm text-green-700 dark:text-green-400">
                                                    Tidak ada titik demo yang tercatat untuk wilayah ini
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div v-if="showUnjukRasaModal" class="fixed inset-0 z-50">
                    ...
                    <div class="fixed inset-0 overflow-y-auto">
                        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                            <!-- Modal panel -->
                            <div
                                class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl dark:bg-gray-800"
                            >
                                <div class="p-6">
                                    <!-- Modal Header -->
                                    <div class="flex items-center justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
                                        <div class="flex items-center">
                                            <div v-if="props.unjukRasaStats.subcategory_info?.image_url" class="mr-3 h-8 w-8 rounded">
                                                <img
                                                    :src="props.unjukRasaStats.subcategory_info.image_url"
                                                    :alt="props.unjukRasaStats.subcategory_info.name"
                                                    class="h-8 w-8 rounded object-contain"
                                            ...
                                            <div v-else class="mr-3 flex h-8 w-8 items-center justify-center text-2xl">
                                                {{ props.unjukRasaStats.subcategory_info?.icon || '📢' }}
                                            </div>
                                            <div>
                                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Data Unjuk Rasa Terbaru</h3>
                                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                    Total {{ props.unjukRasaStats.total_count }} kejadian,
                                                    {{ props.unjukRasaStats.active_count }} masih aktif
                                                </p>
                                            </div>
                                        </div>
                                        <button
                                    ...
                                    <div class="mt-6 max-h-[70vh] overflow-y-auto">
                                        ...
                                        <div>
                                            <h4 class="mb-4 flex items-center text-base font-medium text-gray-900 dark:text-white">
                                                <InformationCircleIcon class="mr-2 h-5 w-5 text-blue-500" />
                                                Kejadian Terbaru
                                            </h4>
                                            ...
                                            <div v-if="props.unjukRasaStats.recent_incidents.length > 0" class="space-y-4">
                                                <div
                                                    ...
                                                    :key="index"
                                                    class="rounded-r-lg border-l-4 bg-white py-3 pl-4 shadow-sm dark:bg-gray-700"
                                                    :class="{
                                                        'border-red-400':
                                                            incident.severity_level === 'critical' || incident.severity_level === 'high',
                                                ...
                                                >
                                                    <div class="flex items-start justify-between">
                                                        <div class="flex-1">
                                                            <div class="flex items-start justify-between">
                                                                <h5 class="flex-1 text-sm font-semibold text-gray-900 dark:text-white">
                                                                    {{ incident.title }}
                                                                </h5>
                                                                <Link
                                                                    :href="route('monitoring-data.show', incident.id)"
                                                                    class="ml-2 flex-shrink-0 p-1 text-gray-400 transition-colors hover:text-blue-600 dark:hover:text-blue-400"
                                                                    :title="`Lihat detail: ${incident.title}`"
                                                                >
                                            ...
                                            <div v-else class="py-8 text-center">
                                                <ShieldExclamationIcon class="mx-auto mb-4 h-12 w-12 text-gray-400" />
                                                <p class="text-sm text-gray-500 dark:text-gray-400">Tidak ada data unjuk rasa terbaru</p>
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="props.unjukRasaStats.by_province.length > 0" class="mt-6">
                                            <h4 class="mb-4 flex items-center text-base font-medium text-gray-900 dark:text-white">
                                                <MapPinIcon class="mr-2 h-5 w-5 text-green-500" />
                                                ...
                                                >
                                                    <div class="flex items-center justify-between">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ province.active_count }} aktif</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-3">
                    <Link
                        ...
                        class="group relative rounded-lg bg-white p-6 shadow transition-shadow duration-200 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-inset hover:shadow-lg dark:bg-gray-800"
                    >
                        <div>
                            <span
                                class="inline-flex rounded-lg bg-indigo-50 p-3 text-indigo-700 ring-4 ring-white dark:bg-indigo-900/50 dark:text-indigo-300 dark:ring-gray-800"
                            >
                                <MapPinIcon class="h-6 w-6" aria-hidden="true" />
                            </span>
                        </div>
                        <div class="mt-8">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Jelajah Wilayah</h3>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Lihat data kabupaten/kota untuk analisis INDAS</p>
                        </div>
                    </Link>
                    ...
                    >
                        <div>
                            <span
                                class="inline-flex rounded-lg bg-green-50 p-3 text-green-700 ring-4 ring-white dark:bg-green-900/50 dark:text-green-300 dark:ring-gray-800"
                            >
                                <ChartBarIcon class="h-6 w-6" aria-hidden="true" />
                            </span>
                        </div>
                        <div class="mt-8">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Jenis Indikator</h3>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Konfigurasi indikator ekonomi, pariwisata, dan sosial</p>
                        </div>
                    </Link>
                    ...
                    >
                        <div>
                            <span
                                class="inline-flex rounded-lg bg-blue-50 p-3 text-blue-700 ring-4 ring-white dark:bg-blue-900/50 dark:text-blue-300 dark:ring-gray-800"
                            >
                                <PlusIcon class="h-6 w-6" aria-hidden="true" />
                            </span>
                        </div>
                        <div class="mt-8">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Input Data</h3>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Masukkan data indikator bulanan dengan nilai langsung</p>
                        </div>
                    </Link>
                </div>
            </div>
