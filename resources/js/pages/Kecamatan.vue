...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Kecamatan', href: '/kecamatan' }];
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Kecamatan</dt>
                                    <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                        {{ statistics.total_kecamatan.toLocaleString() }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Kejahatan</dt>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">Rata-rata per Kecamatan</dt>
                ...
                <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tbody class="divide-y divide-zinc-200 bg-white dark:divide-zinc-700 dark:bg-zinc-900">
                        <tr v-for="item in kecamatan.data" :key="item.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
                            ...
                            <td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900 dark:text-gray-100">{{ item.kabupaten_kota.nama }}</td>
                            <td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900 dark:text-gray-100">
                                {{ item.kabupaten_kota.provinsi.nama }}
                            </td>
                            <td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900 dark:text-gray-100">
                                <span
