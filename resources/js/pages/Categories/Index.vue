        ...
        <div class="flex flex-1 flex-col gap-6 rounded-xl p-6">
            ...
            <div class="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Kelola kategori untuk data monitoring</p>
                </div>
                            ...
                            <tr v-for="category in categories.data" :key="category.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="mt-1 flex items-center">
                                        <div class="mr-2 h-4 w-4 rounded" :style="{ backgroundColor: category.color }"></div>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <Button
                                            ...
                                            size="sm"
                                            :class="
                                                category.is_active ? 'text-orange-600 hover:text-orange-800' : 'text-green-600 hover:text-green-800'
                                            "
                                        >
                                            <svg v-if="category.is_active" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    stroke-width="2"
