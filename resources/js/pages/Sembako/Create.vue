<template>
    <AppLayout title="Tambah Data Sembako">
        <div class="p-6">
            <!-- Header -->
            <div class="mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Tambah Data Sembako</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-400">Masukkan data harga sembako baru</p>
                    </div>
                </div>
            </div>
