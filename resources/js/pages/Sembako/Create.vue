<template>
    <Head title="Tambah Data Sembako" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-1 flex-col gap-6 rounded-xl p-4">
            <!-- Header -->
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Data Sembako</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Tambahkan data harga sembako baru</p>
            </div>
