<template>
    <AppSidebarLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 space-y-6">
            <!-- Header -->
            <div>
                <h1 class="text-2xl font-bold tracking-tight">Edit Menu Item</h1>
                <p class="text-muted-foreground">Ubah informasi menu item</p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Ubah detail menu item di bawah ini
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input
                                    id="icon"
                                    v-model="form.icon"
                                    placeholder="Nama icon (contoh: LayoutGrid)"
                                />
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <Input
                                    id="path"
                                    v-model="form.path"
                                    placeholder="Masukkan path custom (contoh: /dashboard, /indas/data-entry)"
                                />
                            ...
                            <div class="space-y-4 md:col-span-2">
                                ...
                                <p class="text-xs text-muted-foreground ml-6">
                                    Jika dinonaktifkan, menu tidak akan muncul di sidebar
                                </p>

                                <div class="flex items-center space-x-2">
                                    <Checkbox 
                                        id="admin_only" 
                                        v-model:checked="form.admin_only"
                                    />
                                    <label for="admin_only" class="text-sm font-medium">
                                        Hanya untuk Admin
                                    </label>
                                </div>
                                <p class="text-xs text-muted-foreground ml-6">
                                    Menu hanya ditampilkan untuk user dengan role admin
                                </p>
                            </div>
                        </div>
