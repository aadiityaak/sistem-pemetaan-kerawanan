        ...
        <div class="flex flex-1 flex-col gap-6 rounded-xl p-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {{
                        selectedCategory ? `Analisis prediktif data ${getCategoryContext()} menggunakan AI` : 'Analisis prediktif data menggunakan AI'
                    }}
                </p>
            </div>
            ...
            <div v-if="!geminiEnabled" class="rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-yellow-800 dark:text-yellow-200">AI Belum Dikonfigurasi</h3>
            ...
            <div v-if="analysisResult" class="space-y-6">
                ...
                <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-6">
                        <div class="analysis-content max-w-none" v-html="formatAnalysis(analysisResult.analysis)"></div>
                    </div>
                </div>
            </div>

            <!-- Error Message -->
            <div v-if="errorMessage" class="rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20">
                <div class="flex">
...
const formatAnalysis = (analysis: string): string => {
    ...
    let html = analysis
        ...
        .replace(
            /^\s*(\d+)\.\s+(.+)$/gm,
            '<li class="mb-2 text-gray-700 dark:text-gray-300"><span class="font-medium text-blue-600 dark:text-blue-400">$1.</span> $2</li>',
        )
