...
const initAdvancedChart = () => {
    ...
    new window.TradingView.widget({
        ...
        calendar: true,
        news: ['headlines'],
        watchlist: ['IDX:BBCA', 'IDX:BBRI', 'IDX:BMRI', 'IDX:TLKM', 'IDX:ASII', 'IDX:UNVR', 'IDX:ICBP', 'IDX:INDF', 'IDX:GGRM', 'IDX:KLBF'],
    });
};
</script>
