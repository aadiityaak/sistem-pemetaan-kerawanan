    ...
    <AppLayout :title="partaiPolitik.nama_partai">
                    ...
                    <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="text-center">
                                <span
                                    class="inline-flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 text-xl font-bold text-blue-800 dark:bg-blue-900 dark:text-blue-300"
                                >
                            ...
                            <div class="border-t pt-4 dark:border-gray-700">
                                ...
                                <div class="mb-3">
                                    ...
                                    <dd class="text-sm">
                                        <span
                                            v-if="partaiPolitik.status_aktif"
                                            class="inline-flex rounded-full bg-green-100 px-2 py-1 text-xs font-semibold text-green-800 dark:bg-green-900 dark:text-green-300"
                                        >
                                            Aktif di KPU
                                        </span>
                                        <span
                                            v-else
                                            class="inline-flex rounded-full bg-red-100 px-2 py-1 text-xs font-semibold text-red-800 dark:bg-red-900 dark:text-red-300"
                                        >
                                            Tidak Aktif
                                        </span>
                                    </dd>
                                ...
                                <div class="mb-3">
                                    ...
                                    <dd class="text-sm">
                                        <div v-if="partaiPolitik.nama_ketua || partaiPolitik.foto_ketua_url" class="mt-2 flex items-center">
                                            <img
                                            ...
                                            />
                                            <div
                                                class="mr-3 flex h-12 w-12 items-center justify-center rounded-full bg-gray-300 dark:bg-gray-600"
                                                v-else
                                            >
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900 dark:text-gray-100">
                                                    {{ partaiPolitik.nama_ketua || 'Belum diisi' }}
                                                </div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400">Ketua Umum</div>
                                            </div>
                                        </div>
                                        <div v-else class="text-gray-500 italic dark:text-gray-400">Belum diisi</div>
                                    </dd>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            <button
                                ...
                                class="inline-flex items-center rounded-lg bg-green-600 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none"
                            >
                                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Vote Data Table -->
                        <div
                            v-if="partaiPolitik.jumlah_suara.length > 0"
                        ...
                        <div v-else class="py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Mulai dengan menambahkan data jumlah suara untuk tahun pemilu tertentu.
                            </p>
                            <div class="mt-6">
                                <button
                                    @click="showAddVoteModal = true"
        ...
        <Teleport to="body">
            <div v-if="showAddVoteModal || showEditVoteModal" class="fixed inset-0 z-50 flex items-center justify-center">
                ...
                <!-- Modal panel -->
                <div class="relative z-10 mx-4 w-full max-w-lg rounded-lg bg-white shadow-xl dark:bg-gray-800">
                    <div class="p-6">
                        <form @submit.prevent="submitVoteData">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    {{
                                        showEditVoteModal
                                            ? 'Ubah data jumlah suara untuk tahun pemilu'
                            ...
                            <div class="mt-6 space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <div v-if="voteForm.errors.tahun_pemilu" class="mt-1 text-sm text-red-600">
                                        {{ voteForm.errors.tahun_pemilu }}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <div v-if="voteForm.errors.jumlah_suara" class="mt-1 text-sm text-red-600">
                                        {{ voteForm.errors.jumlah_suara }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    class="inline-flex items-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:bg-green-600/50"
                                >
