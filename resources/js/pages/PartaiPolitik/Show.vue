                    ...
                    <form @submit.prevent="submitVoteData">
                        ...
                        <div class="mt-6 flex justify-end gap-3">
                            ...
                            <button
                                ...
                                class="inline-flex items-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-green-600/50"
                            >
