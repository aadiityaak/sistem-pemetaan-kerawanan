                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                >
                                    ...
                                    />
                                    <p v-if="partaiPolitik.nama_ketua" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                        {{ partaiPolitik.nama_ketua }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <!-- Logo Upload -->
                            <div>
                                <label for="logo" class="block text-sm font-medium text-gray-700 dark:text-gray-300"> Ganti Logo Partai </label>
                                <input
                                    id="logo"
                                    type="file"
