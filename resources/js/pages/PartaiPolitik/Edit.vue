                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        <div class="space-y-6">
                            ...
                            <!-- Preview New Logo -->
                            <div v-if="form.logo_url && form.logo_url !== partaiPolitik.logo_url" class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700">
...
const form = useForm({
    ...
    logo_url: props.partaiPolitik.logo_url || '',
    status_aktif: props.partaiPolitik.status_aktif
})

const submit = () => {
    form.put(route('partai-politik.update', props.partaiPolitik.id), {
        preserveScroll: true
    })
}
</script>