        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
            ...
            <div class="flex justify-center">
                <Link :href="route('home')" class="flex flex-col items-center gap-3 hacker-logo">
                    <div class="relative">
                        <div v-if="appSettings.app_favicon && appSettings.app_favicon !== '/favicon.ico'" class="h-32 w-32 rounded-lg bg-black/80 backdrop-blur-sm border border-green-500/30 flex items-center justify-center shadow-lg shadow-green-500/10 glow-box">
                            <img :src="appSettings.app_favicon" :alt="appSettings.app_name" class="h-20 w-20 object-contain filter brightness-0 invert opacity-80" />
                        </div>
                        <div v-else class="h-32 w-32 rounded-lg bg-black/80 backdrop-blur-sm border border-green-500/30 flex items-center justify-center shadow-lg shadow-green-500/10 glow-box">
                            <AppLogoIcon class="h-20 w-20 text-green-400" />
                        </div>
